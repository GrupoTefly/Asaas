...
```bash
composer require GrupoTefly/asaas
```
...
* [Tefly - www.tefly.com.br](https://www.tefly.com.br)

Suporte
-------

[Para reportar um novo bug por favor abra um novo Issue no github](https://github.com/GrupoTefly/asaas/issues)


## Support

###### Security: If you discover any security related issues, please email suporte@tefly.com.br instead of using the issue tracker.

Se você descobrir algum problema relacionado à segurança, envie um e-mail para suporte@tefly.com.br em vez de usar o rastreador de problemas.

Thank you

## Credits

- [Original Package](https://packagist.org/packages/codephix/asaas-sdk)
